...
async function fetchUsers(isActive = null) {
    ...
    try {
        ...
        if (response.ok) {
            ...
            users = data.data; // Populate the users array with fetched data
            filteredUsers = users; // Initialize filtered users to all users
...
// Insert CSS into the document head using JavaScript
